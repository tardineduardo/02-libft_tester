...
/*   Updated: 2024/04/28 17:56:48 by eduribei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
    ...
    tests[4].result = ft_isdigit(tests[4].input);
    tests[4].expected = isdigit(tests[4].input);

    tests[5].input = 'Z';
    tests[5].comment = "uppercase letter";
    tests[5].result = ft_isdigit(tests[5].input);
    tests[5].expected = isdigit(tests[5].input);

    tests[6].input = '5';
    tests[6].comment = "number";
    tests[6].result = ft_isdigit(tests[6].input);
    tests[6].expected = isdigit(tests[6].input);
